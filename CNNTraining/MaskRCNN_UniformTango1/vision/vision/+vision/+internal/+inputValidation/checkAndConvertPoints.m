...
%             cornerPoints, SIFTPoints, SURFPoints, MSERRegions, 
%             BRISKPoints, ORBPoints and M-by-2 numeric matrix. 
%             If pointsIn is not a valid points object, the function will 
%             throw an error.
%
