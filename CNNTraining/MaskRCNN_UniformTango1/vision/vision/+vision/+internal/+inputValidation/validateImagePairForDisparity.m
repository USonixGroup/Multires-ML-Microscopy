function validateImagePairForDisparity(I1, I2, varName1, varName2, varargin)
% validateImagePairForDisparity Validate a pair of images.
...
vision.internal.inputValidation.validateImageForDisparity(I1, varName1, varargin{:});
vision.internal.inputValidation.validateImageForDisparity(I2, varName2, varargin{:});
