...
% Note:
% -----
% This code uses the conversion matrix from RGB to XYZ for the
% PAL/SECAM RGB working space. For a more accurate conversion from RGB to
% LUV, first linearize the RGB data using rgb2lin.
