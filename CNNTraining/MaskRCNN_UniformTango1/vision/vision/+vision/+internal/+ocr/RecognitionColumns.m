classdef RecognitionColumns < vision.internal.ocr.ColumnStrategy
    % RecognitionColumns   OCR training column strategy.
    ...
    methods
        %------------------------------------------------------------------
        function this = RecognitionColumns()
            ...
            this.Column(7).Name = "BaseLearnRate";
            this.Column(7).Type = ".4f";
            this.Column(7).Header = getString(message('vision:trainOCR:learnRate'));
