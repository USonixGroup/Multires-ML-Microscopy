...
%   Copyright 2015-2023 The MathWorks, Inc.
    ...
    properties
        ...
        Theme;  % The current desktop theme
    end
    ...
    methods
        function obj = SelectionLine(ax,loc,min,max)            
            ...
            obj.Group = hggroup('Parent',obj.Axes,...
                'Visible','off');
            % Define the graphics theme to be used
            setTheme(obj);
            % create HG objects
            createLine(obj);
            createBox(obj);
    ...
    methods(Access = private)
        ...
        function createLine(this)
            ...
            y = this.Location;
            lineColor = matlab.graphics.internal.themes.getAttributeValue...
        ...
        function createBox(this)
            ...
            y = val;
            boxColor = matlab.graphics.internal.themes.getAttributeValue...
                (this.Theme, '--mw-graphics-colorSpace-rgb-red');
            this.Box = patch(...
                [x,x,x+width,x+width],...
        ...
        function createTip(this)
            ...
            textColor = matlab.graphics.internal.themes.getAttributeValue...
                (this.Theme, '--mw-graphics-colorSpace-rgb-red');
            this.Tip = text(...
                x,y+yoffset,...
                this.TipText,...
