classdef ParallelFastRCNNSummary < vision.internal.cnn.FastRCNNSummary
%

%   Copyright 2018-2022 The MathWorks, Inc.
    
    methods
        function this = ParallelFastRCNNSummary(varargin)
            this = this@vision.internal.cnn.FastRCNNSummary(varargin{:});
        end
        ...
        function update( this, predictions, response, epoch, iteration, elapsedTime, miniBatchLoss, learnRate, lossFunctionType,currentIterationIsDone )
            ...
            update@vision.internal.cnn.FastRCNNSummary(this, predictions, response, epoch, iteration, elapsedTime, miniBatchLoss, learnRate, currentIterationIsDone);
