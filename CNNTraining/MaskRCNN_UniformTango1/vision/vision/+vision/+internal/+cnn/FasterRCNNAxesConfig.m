classdef FasterRCNNAxesConfig < vision.internal.cnn.AxesConfig
% Plot config for Faster R-CNN.
...
%   Copyright 2020-2023 The MathWorks, Inc.
    ...
    methods
        function this = FasterRCNNAxesConfig()
            
            cellArrayofAxesProperties = {iAccuracyProperties(), iRMSEProperties(), iLossProperties()};
