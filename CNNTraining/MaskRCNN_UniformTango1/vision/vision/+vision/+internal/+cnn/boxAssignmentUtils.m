classdef boxAssignmentUtils
    ...
    % detectors such as RPN, Fast R-CNN, Faster R-CNN, SSD, YOLO v2, etc.    
    ...
    methods(Static)
        ...
        function [assignments, positiveIndex, negativeIndex] = assignBoxesToGroundTruthBoxes(...
            ...
            iou = vision.internal.cnn.boxAssignmentUtils.bboxOverlapIoU(groundTruthBoxes, boxes);
            
            % Assign based on IoU metric.
            [assignments, positiveIndex, negativeIndex] = ...
                vision.internal.cnn.boxAssignmentUtils.assignBoxes(iou, posOverlap, negOverlap, assignAllGroundTruthBoxes);
