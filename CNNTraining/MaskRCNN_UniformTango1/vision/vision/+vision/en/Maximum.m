...
%
%--------------------------------------------------------------------------
%   The vision.Maximum System object will be removed in a future release.
%   Use the max and movmax function instead.
%--------------------------------------------------------------------------
%
...
%   <a href="matlab:help matlab.System/reset   ">reset</a>    - Reset states of running maximum
%
%   Maximum properties:
%
