...
%
%--------------------------------------------------------------------------
%   The vision.Minimum System object will be removed in a future release.
%   Use the min and movmin function instead.
%--------------------------------------------------------------------------
%
...
%   <a href="matlab:help matlab.System/reset   ">reset</a>    - Reset states of running minimum
%
%   Minimum properties:
%
