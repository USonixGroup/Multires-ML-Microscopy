...
%
% -------------------------------------------------------------------------
%   The vision.AlphaBlender System object will be removed in a future release.
%   Use the imblend function with equivalent functionality instead.
% -------------------------------------------------------------------------
%
...
%      imshow(J)
%
%   See also insertText, insertShape, insertMarker, imblend, insertObjectAnnotation,
...
%   Copyright 2004-2024 The MathWorks, Inc.
    ...
    methods
        ...
        function out=helpFixedPoint(~) %#ok<STOUT>
