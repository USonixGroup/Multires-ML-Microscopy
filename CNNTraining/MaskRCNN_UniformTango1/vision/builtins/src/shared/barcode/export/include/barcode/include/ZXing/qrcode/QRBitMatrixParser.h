...
public:
	...
	*/
	...
	static const Version* ReadVersionModel1(const BitMatrix& bitMatrix, bool mirrored);
	...
	*/
	...
	static ByteArray ReadCodewordsModel1(const BitMatrix& bitMatrix, const Version& version);
};
