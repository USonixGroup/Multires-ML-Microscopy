...
public:
	...
	bool isModel1() const { return _isModel1; }
...
private:
	...
	uint8_t _dataMask = 0;
	bool _isModel1 = false;

	FormatInformation(int formatInfo, const bool isModel1);

	static FormatInformation DoDecodeFormatInformation(int maskedFormatInfo1, int maskedFormatInfo2, const bool isModel1);
};
