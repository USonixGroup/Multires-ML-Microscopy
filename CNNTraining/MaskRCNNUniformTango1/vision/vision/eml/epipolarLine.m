...
% If input is a point object, grab only location, else pass
% through to a second variable to support codegen conversion
if isa(points, 'vision.internal.FeaturePointsImpl') ...
