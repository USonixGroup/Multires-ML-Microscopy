...
%   Copyright 2014-2023 MathWorks, Inc.
    ...
    methods(Access=private)
        ...
        function displayInterCameraGeometry(this, stereoParams)
            ...
            rotVector = rotmat2vec3d(stereoParams.PoseCamera2.R);
