function varargout = forward(this,dlFast)
%forward  Compute SlowFast video classifier outputs for training.
%
%   dlYVideo = forward(sf, dlXVideo) returns SlowFast video classifier
%   outputs for training. The input sf is a slowFastVideoClassifier object.
...
%   network.
%
%   [dlYVideo,stateVideo] = forward(sf, dlXVideo) also returns the updated
...
%
%   Example: Forward video using SlowFast for training.
%   ---------------------------------------------------
...
%   activations = forward(sf,dlVideo);
%
% See also slowFastVideoClassifier/predict, r2plus1dVideoClassifier,
...
%   Copyright 2021-2023 The MathWorks, Inc.
    ...
    [varargout{1:nargout}] = this.Network.forward(dlSlow,dlFast);
end
