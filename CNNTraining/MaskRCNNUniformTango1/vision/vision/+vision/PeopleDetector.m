classdef (StrictDefaults)PeopleDetector < matlab.System 
    %PeopleDetector Detect upright people using HOG features
    %
    %--------------------------------------------------------------------------
    %   The vision.PeopleDetector System object will be removed in a future
    %   release. Use the peopleDetectorACF function instead.
    %--------------------------------------------------------------------------
    %
    ...
    properties(Nontunable)
        ...
        %
        %   Default: true
        MergeDetections (1, 1) logical = true; 
    ...
    methods
        ...
        function obj = PeopleDetector(varargin)
            error(message("vision:obsolete:removeFunctionality","vision.PeopleDetector","peopleDetectorACF"));  
            if (isSimMode())
