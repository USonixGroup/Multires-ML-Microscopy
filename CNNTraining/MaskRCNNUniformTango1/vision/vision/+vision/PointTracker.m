classdef (StrictDefaults)PointTracker < matlab.System
...
%#ok<*EMCA>
  ...
  methods(Access=protected)
    ...
    function [points, pointValidity, scores] = stepImpl(obj, I)
      ...
      % Indexing will ensure Iu8_gray is a 2d matrix to coder during
      % compile time
      Iu8_gray = Iu8_grayImg(:,:,1);
