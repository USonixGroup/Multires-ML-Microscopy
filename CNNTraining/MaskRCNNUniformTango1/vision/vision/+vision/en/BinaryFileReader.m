...
%   <a href="matlab:help matlab.System/reset   ">reset</a>    - Reset to the beginning of the file
...
%   Copyright 2008-2018 The MathWorks, Inc.
    ...
    methods
        ...
        function out=checkAndAdjustVideoComponentOrder(~) %#ok<STOUT>
        end

        function out=isCustomFormat(~) %#ok<STOUT>
        end
        ...
        function out=isPackedFormat(~) %#ok<STOUT>
        end
