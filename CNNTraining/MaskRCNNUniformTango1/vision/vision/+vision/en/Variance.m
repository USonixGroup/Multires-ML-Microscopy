...
%
%--------------------------------------------------------------------------
%   The vision.Variance System object will be removed in a future release.
%   Use the var and movvar function instead.
%--------------------------------------------------------------------------
%
...
%   <a href="matlab:help matlab.System/reset   ">reset</a>    - Reset the states of running variance
%
%   Variance properties:
%
