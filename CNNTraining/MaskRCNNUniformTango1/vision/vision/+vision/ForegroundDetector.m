classdef (StrictDefaults)ForegroundDetector < matlab.System
...
%#ok<*EMCA>
    properties(Nontunable)
        ...
        %
        %   Default: true
        AdaptLearningRate (1, 1) logical = true;
    ...
    properties(Access = private, Hidden)
        hasConstructed (1, 1) logical = false; %only for codegen
    end
        ...
        % load object properties                
            ...
            if wasLocked
                ...
                if isempty(coder.target)
                    ...
                    if strcmp(obj.ImageClass, 'float')
                        imageClass = 'single';
                    else
                        imageClass = obj.ImageClass;
                    end

                    obj.pForegroundDetector.initialize(ones([obj.FrameSize obj.NumChannels], imageClass),...
                                                       obj.NumGaussians,...
                                                       obj.pInitialVariance,...
                                                       obj.InitialWeight,...
                                                       obj.VarianceThreshold,...
