% AutoPopulateCharucoPropsDlg Dialog for displaying success or failure
% status of the ChArUco board properties detection.

% Copyright 2024 The MathWorks, Inc.

classdef AutoPopulateCharucoPropsDlg
    ...
    methods
        ...
        function this = initializeProperties(this, caller, filename, parentDlgLoc, varargin)
            ...
            if nargin > 5
                ...
                this.Title = vision.getMessage("vision:caltool:AutoPopulationSuccessTitle");
                props = [num2cell(varargin{1}), varargin{2:end}];
                this.Message = vision.getMessage("vision:caltool:DetectedPropsMsg", props{:});
            else
                this.DlgType = "ErrorDlg";
                this.ButtonsLayout = {"1x","fit","1x"};
                this.DlgSize = [550 220];
                this.Title = vision.getMessage("vision:caltool:AutoPopulationFailedTitle");
                this.Message = vision.getMessage("vision:caltool:AutoPopulationFailedMsg", varargin{:});
            end
    ...
    methods
        %----------------------------------------------------------------------
        function this = AutoPopulateCharucoPropsDlg(parent, filename, parentDlgLoc, varargin)
