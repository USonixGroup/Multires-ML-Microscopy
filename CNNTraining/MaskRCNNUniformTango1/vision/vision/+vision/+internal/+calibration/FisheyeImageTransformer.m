...
classdef FisheyeImageTransformer < handle
    ...
    methods(Access=public)        
        ...
        function this = FisheyeImageTransformer()
            ...
            sizeOfImage = [0 0 0];
            coder.varsize('sizeOfImage', [1 3]);
            this.SizeOfImage = sizeOfImage;

            classOfImage = 'uint8';
            coder.varsize('classOfImage', [1 Inf]);
            this.ClassOfImage = classOfImage;
            
            outputView = 'same';
            coder.varsize('outputView', [1 Inf]);
            this.OutputView = outputView;

            mappingMethod = 'approximate';
            coder.varsize('mappingMethod', [1 Inf]);
        ...
        function computeMap(this, mappingCoefficients, stretchMatrix, ...
            ...
            if ~skipMappingStep
                ...
                if coder.target('MATLAB')
                    eval('clear points3D'); % be careful with memory
                end
