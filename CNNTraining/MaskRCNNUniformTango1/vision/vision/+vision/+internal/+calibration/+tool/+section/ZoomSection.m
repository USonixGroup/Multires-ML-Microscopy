...
%   Copyright 2014-2023 The MathWorks, Inc.
    ...
    methods
     ...
     %------------------------------------------------------------------
        ...
        function disableButtons(this)
            ...
            % contained in zoomSection. The buttons will appear garyed-out.
    ...
    methods (Access = private)
        function createSection(this)
            title = getString(message('vision:uitools:ZoomSection'));
            tag = 'sectionZoom';
        ...
        function addZoomInButton(this)
            zoomInIcon = matlab.ui.internal.toolstrip.Icon('zoomIn');
        ...
        function addZoomOutButton(this)
            zoomOutIcon = matlab.ui.internal.toolstrip.Icon('zoomOut');
        ...
        function addPanButton(this)
            panIcon = matlab.ui.internal.toolstrip.Icon('pan');
