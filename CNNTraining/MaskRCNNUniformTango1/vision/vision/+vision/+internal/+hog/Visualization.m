...
%
%   'Color'   Specify the color used to plot HOG features as an
%             RGB triplet or a string or character vector that
%             specifies a long or short color name.
%
%             Default: 'white'
%
...
%   Copyright 2013-2020 The MathWorks, Inc.
    ...
    methods    
        ...
        function hData = plot(this,varargin)
            ...
            %  arguments:
            %
            %   'Color' Specifies the color used to plot HOG features as an
            %           RGB triplet or a string or character vector that
            %           specifies a long or short color name.
            % 
            %           Default: 'white'
