...
% algorithm with a blockedImage context, to be used in the Image Labeler
% App.
%
...
%   >> doc vision.labeler.mixin.BlockedImageAutomation
%
% For reference, see the following AutomationAlgorithm classes:
%
%
% To use this algorithm from within the Image Labeler App, follow the steps
...
%  algorithm from within the Image Labeler app. You can add a folder to the
%  path using the ADDPATH function.
%
%  Save your algorithm class in the folder created in step 1. Refresh the
%  algorithm list from within the Image Labeler app to start using your
%  custom algorithm.

classdef BlockedImageAutomationAlgorithmExample < vision.labeler.AutomationAlgorithm & vision.labeler.mixin.BlockedImageAutomation
...
%   Copyright 2020 The MathWorks, Inc.
    ...
    properties(Constant)
        ...
        Name = 'Example Custom BlockedImage Automation Algorithm';
        
        % Description: Provide a one-line description for your algorithm.
        Description = 'This is an example of a custom blockedImage automation algorithm.';
    ...
    methods
        ...
        % b) Specify the blockedImageAutomationAlgorithm method to process
        %    a block of an image and execute the algorithm.
        %
        %    For more help,
        %    >> doc vision.labeler.mixin.BlockedImageAutomation.blockedImageAutomationAlgorithm
        %
        ...
        % c) Specify the run method to process an image and execute
        %    the algorithm. Algorithm execution begins at the first image
        %    frame in the interval and is sequentially invoked till the
        %    last image frame in the interval. 
        %
        %
        function bout = run(algObj, bim)
            
            disp(['Executing run on image']);
            % Call the convenience function to automatically call "apply"
            bout = algObj.blockedImageApply(bim);
            %--------------------------------------------------------------
            % Place your code here
            %--------------------------------------------------------------
        ...
        % d) Specify the terminate method to clean up state of the executed
