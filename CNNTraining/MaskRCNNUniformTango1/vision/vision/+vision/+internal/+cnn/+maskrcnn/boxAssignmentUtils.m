classdef boxAssignmentUtils
    ...
    methods(Static)
        ...
        function [assignments, positiveIndex, negativeIndex] = assignBoxesToGroundTruthBoxes(...
            ...
            iou = vision.internal.cnn.maskrcnn.boxAssignmentUtils.bboxOverlapIoU(groundTruthBoxes, boxes);
            
            % Assign based on IoU metric.
            [assignments, positiveIndex, negativeIndex] = ...
                vision.internal.cnn.maskrcnn.boxAssignmentUtils.assignBoxes(iou, posOverlap, negOverlap, assignAllGroundTruthBoxes);
