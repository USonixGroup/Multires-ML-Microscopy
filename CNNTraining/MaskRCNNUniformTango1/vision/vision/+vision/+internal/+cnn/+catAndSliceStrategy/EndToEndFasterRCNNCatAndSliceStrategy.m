classdef EndToEndFasterRCNNCatAndSliceStrategy < handle
    % EndToEndFasterRCNNCatAndSliceStrategy A strategy for concatenating and slicing
...
function response = iCatResponseFcn(~, response, extras)
    ...
    response{2} = vertcat(response{2},extras{2});
end
