...
%  vision.internal.OpenPatternDetectorTemplate('monocular') opens a custom calibration
%  pattern detector template for single camera calibration in the MATLAB editor.
%
%  vision.internal.OpenPatternDetectorTemplate('stereo') opens a custom calibration
...
%   Copyright 2021 The MathWorks, Inc.
    ...
    if strcmp(cameraType, 'monocular')
        template = fullfile(matlabroot, 'toolbox','vision','vision','+vision','+internal','+calibration',...
