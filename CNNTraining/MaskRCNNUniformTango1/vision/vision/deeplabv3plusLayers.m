...
%
%--------------------------------------------------------------------------
%   deeplabv3plusLayers will be removed in a future release. Use deeplabv3plus instead.
%--------------------------------------------------------------------------
%
...
%
%   Example: Create DeepLab v3+ based on ResNet-18.
%   -----------------------------------------------
...
warning(message('vision:semanticseg:deeplabv3plusLayersDeprecation'));
