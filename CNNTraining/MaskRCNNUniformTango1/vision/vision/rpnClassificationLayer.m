function layer = rpnClassificationLayer(varargin)           
...
numClasses = []; % will be set during training.
internalLayer = vision.internal.cnn.layer.RPNCrossEntropy(params.Name, numClasses);

% Pass the internal layer to a function to construct a user visible layer.
layer = nnet.cnn.layer.RPNClassificationLayer(internalLayer);
