...
%classifySequence  Classify the video sequence using the R(2+1)D Video Classifier.
%
%   label = classifySequence(rd) classifies the video sequence stored in
%   the VideoSequence property. The input rd is an r2plus1dVideoClassifier
...
%   classifier object.
%
%   [label, score] = classifySequence(rd) additionally returns the
...
%          r2plus1dVideoClassifier/updateSequence, r2plus1dVideoClassifier/predict.
...
%   Copyright 2021-2023 The MathWorks, Inc.
    ...
    if this.NumFramesCollected < sequenceLength 
        error(message('r2plus1d:r2plus1dVideoClassifier:classifySequenceNotEnoughFrames', string(sequenceLength)));
    end
