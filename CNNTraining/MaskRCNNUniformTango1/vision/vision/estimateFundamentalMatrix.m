...
%   objects, SIFTPoints objects, SURFPoints objects, KAZEPoints objects, 
%   MSERRegions objects, BRISKPoints objects, ORBPoints objects, or M-by-2
%   matrices of [x,y] coordinates. matchedPoints1 and matchedPoints2 must 
%   contain points which are putatively matched by using a function such as
%   matchFeatures.
%  
%   [F, inliersIndex] =
...
%   SIFTPoints objects, SURFPoints objects, KAZEPoints objects, MSERRegions
%   objects, BRISKPoints objects, or M-by-2 matrices of [x,y] coordinates.
%
%   Example 1
%   ---------
...
if isSimulationMode
    ...
    method              = char(lower(r.Method));
    outputClass         = char(lower(r.OutputClass));
    distanceType        = char(lower(r.DistanceType));
