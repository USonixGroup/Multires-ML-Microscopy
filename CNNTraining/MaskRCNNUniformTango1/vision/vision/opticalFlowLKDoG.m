...
%   described below:
%
%   'NumFrames'             Number of frames to buffer for temporal
%                           smoothing, specified as a positive
%                           integer-valued scalar. A higher number of
%                           frames reduces the impact of abrupt movements
%                           in optical flow computation.
%
%                           Default: 3
%
...
%                           Default: 1.5
%
%   'GradientFilterSigma'   Standard deviation for gradient smoothing
%                           filter, specified as a positive scalar.
%
%                           Default: 1
%
%   'NoiseThreshold'        Threshold for noise reduction specified as a
%                           positive scalar. A higher noise threshold,
%                           reduces the impact of small movements in
