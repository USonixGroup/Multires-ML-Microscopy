...
const Version *
Version::AllVersionsModel1()
{
	/**
	* See buildVersionsModel1 in ZXing Model 1 fork (Java):
	* https://github.com/george-hopkins/zxing/blob/qrmodel1/core/src/main/java/com/google/zxing/qrcode/decoder/Version.java
	*/
	static const Version allVersionsModel1[] = {
		{1, {}, {
			7,  1, 19, 0, 0,
			10, 1, 16, 0, 0,
			13, 1, 13, 0, 0,
...
const Version *
Version::VersionForDimensionModel1(int dimension)
{
	if (dimension % 4 != 1) {
		return nullptr;
	}
	...
	return &AllVersionsModel1()[versionNumber - 1];
}
