...
class  PointBuffers
{
  public:
    ...
    void setValidity(const boolean_T *validityData);
...
inline void PointBuffers::allocatePointBuffers(bool useBidirectionalConstraint)
{
    ...
    mStatus1.resize(mNPoints, (boolean_T)1);
    mStatus2.resize(mNPoints, (boolean_T)1);
    mErr.resize(mNPoints);
    
    if(useBidirectionalConstraint)
    {
        mTmpPoints.resize(mNPoints);
        mTmpStatus.resize(mNPoints, (boolean_T)1);
...
{
  std::fill(mStatus1.begin(), mStatus1.end(), (boolean_T)1);
}

///////////////////////////////////////////////////////////////////////////////
inline void PointBuffers::setValidity(const boolean_T *validityData)
{    
