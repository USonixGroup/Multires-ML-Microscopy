...
template<class T>
        ...
        mwSize numValidRows, mwSize numValidCols,
        mwSize numOutRows, mwSize numOutCols,
        T invalidValue, mwSize borderWidth)
{
    mwSize r, c;
    for (r = 0; r<numValidRows-borderWidth; r++)
    {
...
inline void transposeClipAndCastBM(int16_T* in, real32_T* out,
        mwSize numValidRows, mwSize numValidCols,
        mwSize numOutRows,   mwSize numOutCols,
        mwSize numInRows,    int16_T invalidValue, mwSize borderWidth, real32_T invalidDisparityValue)
{
    mwSize r, c;
    for(c=0; c<numValidCols; c++)
    {
        for(r=0; r<numValidRows-borderWidth; r++)
        {
            ...
            {
                out[r*numOutCols+c] = invalidDisparityValue;
            }
        }
...
inline void copyClipAndCastBMRM(int16_T* in, real32_T* out,
        mwSize numValidRows, mwSize numValidCols,
        mwSize numOutRows, mwSize numOutCols,
        int16_T invalidValue, mwSize borderWidth, real32_T invalidDisparityValue)
{
    mwSize r, c;
    for (r = 0; r<numValidRows - borderWidth; r++)
    {
