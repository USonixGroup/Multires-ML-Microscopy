        ...
        int nRows, int nCols, real32_T* dis, cvstDBMStruct_T *params)
{
    ...
    cv::Ptr<cv::StereoBM> bm = cv::StereoBM::create((int)params->numberOfDisparities, (int)params->SADWindowSize);
    ...
    transposeClipAndCastBM(outData, dis, numInCols, numRows, numInCols, numRows,
            numCols, invalidValue, borderWidth,(float)params->invalidDisparityValue);
}
        ...
        int nRows, int nCols, real32_T* dis, cvstDBMStruct_T *params)
{
    ...
    copyClipAndCastBMRM(outData, dis, numInCols, numRows, numInCols, numRows,
            invalidValue, borderWidth,(float)params->invalidDisparityValue);
}
