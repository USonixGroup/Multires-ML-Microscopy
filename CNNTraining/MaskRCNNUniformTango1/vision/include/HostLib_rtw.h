...
/* *******************************************************************
 * THIS IS A COPY OF A FILE NOW IN DSP_ML_CORE (SRC_ML) COMPONENT
 * UNDER toolbox/shared/spc/src_ml/extern/include/DAHostLib_rtw.h
 * THIS FILE WILL BE REMOVED AT SOME POINT. USE THE ABOVE INSTEAD.
 * *******************************************************************
 */
