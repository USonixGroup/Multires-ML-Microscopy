    ...
    methods
        ...
        function setBlockParams(this, ed)
            ...
            try
                ...
                minInputVal = mat2str(getScopeParam(hScope, 'Visuals', 'Video', 'DataRangeMin'));
                maxInputVal = mat2str(getScopeParam(hScope, 'Visuals', 'Video', 'DataRangeMax'));
        ...
        function [mApp, mExample, mAbout] = createHelpMenuItems(~, mHelp)
            ...
            mApp(1) = uimenu(mHelp, ...
                ...
                'Callback', @(hco,ev) helpview('vision', 'vipvideoviewer'));
        ...
        function helpArgs = getHelpArgs(~, key)
            ...
            switch lower(key)
                case 'colormap'
                    helpArgs = {'helpview', 'vision', 'video_viewer_colormap'};
                case 'overall'
        ...
        function onFileMenuOpening(this, hScope, ~)
            ...
            if isempty(menus)
                ...
                menus.openAtModelStart = uimenu(hFileMenu, ...
                    'Label', getString(message('dspshared:FromMMFile:OpenAtStartOfSimulation')), ...
                    'Position', 1, ...
                    'Tag', 'uimgr.spctogglemenu_OpenAtMdlStart', ...
                    'Callback', @(~, ~) toggleOpenAtMdlStart(this));
                menus.threePorts = uimenu(hFileMenu, ...
                    'Position', 2, ...
                    'Separator', 'on', ...
                    'Tag', 'uimgr.spctogglemenu_MultiImagePort', ...
                    'Label', getString(message('dspshared:FromMMFile:SeparateColorSignalsMenu')), ...
                ...
                menus.onePort = uimenu(hFileMenu, ...
                    ...
                    'Label', getString(message('dspshared:FromMMFile:OneMultidimensionalSignalMenu')), ...
