...
#$ -wd /home/zcemydo/Scratch/TrainResNext
...
cp ~/Scratch/TrainResNext/ResN101.m $TMPDIR
...
#run matlab script(s)
matlab -nosplash -nodesktop -nodisplay < ResN101.m


# tar up all contents of $TMPDIR back into your space
tar zcvf $HOME/Scratch/TrainResNext/ResN101_${JOB_ID}.tgz $TMPDIR
