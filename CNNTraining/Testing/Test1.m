...
net = MRCNN(trainClassNames,ABs,InputSize=imageSizeTrain, ScaleFactor=[1 1]/16,ModelName='BasicNet')
...
[net,info] = trainMRCNN(ds,net,options, NumStrongestRegions=150, NumRegionsToSample=150, PositiveOverlapRange=[0.5 1], NegativeOverlapRange=[0 0.5], ForcedPositiveProposals=true, FreezeSubNetwork="backbone") 
...
%net.MinScore = 0.001;
     [masks,labels,scores,boxes] = segmentObjects(net,im,Threshold=0.25,NumStrongestRegions=Inf, SelectStrongest=true, MinSize=[1 1],MaxSize=[80 80] );
toc
