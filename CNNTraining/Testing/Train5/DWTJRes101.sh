...
#$ -wd /home/zcemydo/Scratch/Train5
...
cp ~/Scratch/Train5/Res101DWT.m $TMPDIR
...
#run matlab script(s)
matlab -nosplash -nodesktop -nodisplay < Res101DWT.m


# tar up all contents of $TMPDIR back into your space
tar zcvf $HOME/Scratch/Train5/Res101DWT_${JOB_ID}.tgz $TMPDIR
