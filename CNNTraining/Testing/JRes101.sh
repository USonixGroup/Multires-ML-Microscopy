...
#$ -wd /home/zcemydo/Scratch/Train2
...
cp ~/Scratch/Train2/Res101.m $TMPDIR
...
#run matlab script(s)
matlab -nosplash -nodesktop -nodisplay < Res50.m


# tar up all contents of $TMPDIR back into your space
tar zcvf $HOME/Scratch/Train2/Res101_${JOB_ID}.tgz $TMPDIR
