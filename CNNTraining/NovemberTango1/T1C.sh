...
#$ -wd /home/zcemydo/Scratch/NewTrain1
...
cp ~/Scratch/NewTrain1/Train1Cat.m $TMPDIR
cp ~/Scratch/NewTrain1/cocoAnnotationMATReader.m $TMPDIR
cp -r ~/Scratch/NewTrain1/src $TMPDIR
...
#run matlab script(s)
matlab -nosplash -nodesktop -nodisplay < Train1Cat.m


# tar up all contents of $TMPDIR back into your space
tar zcvf $HOME/Scratch/NewTrain1/files_from_job_${JOB_ID}.tgz $TMPDIR
