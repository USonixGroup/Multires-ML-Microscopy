...
load("~/Scratch/NetworksUntrained/ParamsV1Cat1Channel4.mat")
    ...
    mb.shuffle();
        ...
        while mb.hasdata()
            ...
            if rem(numIteration, savefreq) == 0
                    ...
                    save("~/Scratch/CheckPoints/DWTC1"+modelDateTime+".mat", "savenet"); %save output with the date and time into the current directotry
            end
