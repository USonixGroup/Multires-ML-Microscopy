...
load("~/Scratch/NetworksUntrained/ParamsV1Cat8Channel1.mat")
    ...
    mb.shuffle();
        ...
        while mb.hasdata()
            ...
            if rem(numIteration, savefreq) == 0
                    ...
                    save("~/Scratch/CheckPoints/C8"+modelDateTime+".mat", "savenet"); %save output with the date and time into the current directotry
            end
