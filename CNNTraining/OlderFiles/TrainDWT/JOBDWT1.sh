...
#$ -wd /home/zcemydo/Scratch/TrainDWT
...
cp ~/Scratch/TrainDWT/trainmyriaddwt.m $TMPDIR
cp ~/Scratch/TrainDWT/matreaderDWT.m $TMPDIR
cp -r ~/Scratch/TrainDWT/src $TMPDIR
...
#run matlab script(s)
matlab -nosplash -nodesktop -nodisplay < trainmyriaddwt.m


# tar up all contents of $TMPDIR back into your space
tar zcvf $HOME/Scratch/TrainDWT/files_from_job_${JOB_ID}.tgz $TMPDIR
