...
%load("NET101-4D.mat")
load("/home/zcemydo/Scratch/Train1C/1ChannelNet.mat")
...
dlnet=gather(dlnet);
modelDateTime = string(datetime("now",Format="yyyy-MM-dd-HH-mm-ss"));
                    save("~/Scratch/Train1C/NetData101/FINAL"+modelDateTime+".mat"); %save output with the date and time into the current directotry
