...
#$ -wd /home/zcemydo/Scratch/TrainV7
...
cp ~/Scratch/TrainV7/Train1.m $TMPDIR
cp ~/Scratch/TrainV7/cocoAnnotationMATReader.m $TMPDIR
cp -r ~/Scratch/TrainV7/src $TMPDIR
...
#run matlab script(s)
matlab -nosplash -nodesktop -nodisplay < Train1.m


# tar up all contents of $TMPDIR back into your space
tar zcvf $HOME/Scratch/TrainV7/files_from_job_${JOB_ID}.tgz $TMPDIR
