...
load("~/Scratch/NewTrain1/Cat1Channel4.mat")
    ...
    mb.shuffle();
        ...
        while mb.hasdata()
            ...
            if rem(numIteration, savefreq) == 0
                    ...
                    save("~/Scratch/NewTrain1/NetData101/Cat1DWT-Checkpoint-"+modelDateTime+".mat", "savenet"); %save output with the date and time into the current directotry
            end
