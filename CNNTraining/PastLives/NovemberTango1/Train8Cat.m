...
load("~/Scratch/NewTrain1/ParamsV2Cat8Channel1.mat")
    ...
    mb.shuffle();
        ...
        while mb.hasdata()
            ...
            if rem(numIteration, savefreq) == 0
                    ...
                    save("~/Scratch/NewTrain1/NetData101/Cat8-v2-Checkpoint-"+modelDateTime+".mat", "savenet"); %save output with the date and time into the current directotry
            end
