...
public:
    ...
    void setPoints(int numPoints, const float *pointData, const boolean_T *validityData=NULL)
    {
      mPointBuffers.setPoints(numPoints, pointData, 
                              mParams.useBidirectionalConstraint());
      if(validityData)
	...
	void setPointsRM(int numPoints, const float *pointData, const boolean_T *validityData = NULL)
	{
		mPointBuffers.setPointsRM(numPoints, pointData,
			mParams.useBidirectionalConstraint());
		if (validityData)
