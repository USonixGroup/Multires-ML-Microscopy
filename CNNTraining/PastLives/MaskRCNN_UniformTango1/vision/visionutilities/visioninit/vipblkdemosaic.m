function vipblkdemosaic(action)
% VIPBLK2DDEMOSAIC Mask dynamic dialog function for Demosaic block
...
signedColumnLabel         = blkMask.getDialogControl('signedTextLabel');
wordLengthColumnLabel     = blkMask.getDialogControl('wordLengthLabel');
fractionLengthColumnLabel = blkMask.getDialogControl('fracLengthLabel');
...
if  (strcmp(accumMode, 'Same as input')||strcmp(accumMode, 'Same as product output'))...
