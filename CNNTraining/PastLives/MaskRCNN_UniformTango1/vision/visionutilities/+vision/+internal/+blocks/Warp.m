classdef  Warp < matlab.System
    ...
    %
    %   See also estimateGeometricTransform2D, imwarp
    ...
    properties (Constant, Hidden)
        TransformMatrixSourceSet = ...
            matlab.system.internal.MessageCatalogSet({'vision:masks:Custom', 'vision:masks:InputPort'});
        InterpolationMethodSet = ...
            matlab.system.internal.MessageCatalogSet({'vision:masks:NearestNeighbor', 'vision:masks:Bilinear', 'vision:masks:Bicubic'});
        OutputImagePositionSourceSet = ...
            matlab.system.internal.MessageCatalogSet({'vision:masks:SameAsInputImage', 'vision:masks:Custom'});
    end
    ...
    methods(Static, Access=protected)
        ...
        function header = getHeaderImpl()
            header = matlab.system.display.Header('vision.internal.blocks.Warp',...
                'Title', getString(message('vision:warp:warp')), 'Text', ...
        ...
        function group = getPropertyGroupsImpl()            
            ...
            group = matlab.system.display.Section('Title', ...
                getString(message('vision:masks:Parameters')), ...
