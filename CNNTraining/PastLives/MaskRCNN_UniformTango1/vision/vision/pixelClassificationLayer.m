...
%                      specified. When specifying ClassWeights, Classes
%                      must not be 'auto'.
% 
%                      Default: 'none'
%
...
%     % frequencies over the training data using pixelLabelDatastore.
...
%          deeplabv3plusLayers, segnetLayers, fcnLayers, 
%          unetLayers, nnet.cnn.layer.PixelClassificationLayer.
