...
%
%--------------------------------------------------------------------------
%   segnetLayers will be removed in a future release. Create a SegNet
%   network using a dlnetwork (Deep Learning Toolbox) object instead.
%--------------------------------------------------------------------------
%
...
warning(message('vision:semanticseg:segnetLayersDeprecation'));
