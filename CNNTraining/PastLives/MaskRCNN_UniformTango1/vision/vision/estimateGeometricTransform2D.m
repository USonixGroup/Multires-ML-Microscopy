...
%
%------------------------------------------------------------------------------
%   estimateGeometricTransform2D is not recommended. Use estgeotform2d instead.
%------------------------------------------------------------------------------
%
%   tform = estimateGeometricTransform2D(matchedPoints1, matchedPoints2, transformType)
%   returns a 2-D geometric transformation which maps the inliers in
%   matchedPoints1 to the inliers in matchedPoints2. matchedPoints1 and
%   matchedPoints2 can be M-by-2 matrices of [x,y] coordinates or objects
%   of any of the point feature types (cornerPoints, BRISKPoints, SIFTPoints,
%   SURFPoints, ORBPoints, KAZEPoints, MSERRegions). transformType can be
%   'rigid', 'similarity', 'affine', or 'projective'. Returned tform types
%   are as follows:
%
%   -------------------------------------
...
%   Class Support
%   -------------
%   matchedPoints1 and matchedPoints2 can be numeric when specified as an
%   M-by-2 matrix.
%
...
%
% See also estgeotform2d, estgeotform3d, rigidtform2d, affinetform2d,
%          simtform2d, projtform2d, fitgeotrans, cornerPoints, SIFTPoints, 
%          SURFPoints, MSERRegions, BRISKPoints, ORBPoints, ransac,
%          detectMinEigenFeatures, detectFASTFeatures, detectSIFTFeatures,
%          detectSURFFeatures, detectMSERFeatures, detectBRISKFeatures,
%          detectORBFeatures, matchFeatures, imwarp, extractFeatures.
