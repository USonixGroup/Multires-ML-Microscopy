...
classdef MultiSignalAutomationAlgorithmExample < vision.labeler.AutomationAlgorithm & vision.labeler.mixin.Temporal
...
%   Copyright 2019-2020 The MathWorks, Inc.
    ...
    methods (Static)
        ...
        function isValid = checkSignalType(signalType)
            ...
            % Sample code for both Image and PointCloud signal types:
        ...
        % b) Use the supportsMultisignalAutomation method to specify
        %    whether the algorithm supports automation of multiple signals.
        %    This method is invoked for the selected algorithm to determine
        %    whether it is valid for the multiple signals.
        %
        %    For more help,
        %    >> doc vision.labeler.AutomationAlgorithm.supportsMultisignalAutomation
        %
        function success = supportsMultisignalAutomation(~)
            ...
            % Sample code to set algorithm supported for multiple signals    
            % success = false;
        end
    ...
    methods
        ...
        % c) Use the checkLabelDefinition method to specify whether a label
        ...
        % d) Use the checkSetup method to specify whether the algorithm is
        ...
        % e) Optionally, specify what settings the algorithm requires by
