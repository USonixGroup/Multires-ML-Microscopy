...
if nargin<2 || isempty(internalCodeSearchPattern)
    ...
    internalCodeSearchPattern = ...
        ...
        ['\n[^\n]*',regexptranslate('escape', fullfile(matlabroot,'toolbox','vision','vision','+vision','+internal','+videoLabeler'))]          % gtl app internals
        ...
        ['\n[^\n]*',regexptranslate('escape', fullfile(matlabroot,'toolbox','vision','vision','+vision','+labeler','+mixin'))]                  % mixin internals
