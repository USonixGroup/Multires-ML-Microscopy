classdef DetectorCheckpointIterationSaver < nnet.internal.cnn.trainNetwork.reporter.checkpoint.IterationReporter
    % DetectorCheckpointIterationSaver   This class is used to save
    % detector checkpoints at certain iterations during network training.
    % Use this class if you have a detector that contains a network that
    % you'd like to checkpoint.
    ...
    methods
        function this = DetectorCheckpointIterationSaver( checkpointSaver )            
             this@nnet.internal.cnn.trainNetwork.reporter.checkpoint.IterationReporter(checkpointSaver);                                  
        end
        ...
        function reportIteration( this, summary, network)
            iteration = summary.Iteration;
            if this.Saver.canSaveThisInstance(iteration)
