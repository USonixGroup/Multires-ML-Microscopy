...
% Copyright 2020 The MathWorks, Inc.
    ...
    methods
        ...
        function [x, y] = getTrainingSamples(~, data, th)
            ...
            [G, P, selected] = vision.internal.cnn.maskrcnn.BoundingBoxRegressionModel.selectBBoxesForTraining(G, P, th);
            
            x = F(:, selected);
            
            y = vision.internal.cnn.maskrcnn.BoundingBoxRegressionModel.generateRegressionTargets(G, P);
    ...
    methods(Static)        
        ...
        function [targets, positiveIndex, negativeIndex, assignments] = generateRegressionTargetsFromProposals(...
            ...
            [assignments, positiveIndex, negativeIndex] = ...
                vision.internal.cnn.maskrcnn.boxAssignmentUtils.assignBoxesToGroundTruthBoxes(...
            ...
            if isempty(groundTruth)
                ...
                targets = vision.internal.cnn.maskrcnn.BoundingBoxRegressionModel.generateRegressionTargets(G, P);
