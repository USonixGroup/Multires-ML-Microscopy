function validateImageForDisparity(I, varName, imageType)
...
%
% validateImageForDisparity(I,varName, imageType) checks that the image is
...
classAttributes = {'double','single','int16','uint16','uint8'};
