...
%
%--------------------------------------------------------------------------
%   The vision.StandardDeviation System object will be removed in a future
%   release. Use the std and movstd function instead.
%--------------------------------------------------------------------------
%
...
%   <a href="matlab:help matlab.System/reset   ">reset</a>    - Resets the running standard deviation state.
%
