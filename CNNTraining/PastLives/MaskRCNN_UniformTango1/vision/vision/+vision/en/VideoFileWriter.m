...
%   The VideoFileWriter writes video and/or audio to an AVI file. The video
%   and audio can be compressed. The available compression types depend on
...
%   type is determined by the FileFormat property described below.
%
...
%
%   See also VideoReader, vision.VideoPlayer, implay
