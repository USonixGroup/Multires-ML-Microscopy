...
%
%--------------------------------------------------------------------------
%   The vision.Mean System object will be removed in a future release. Use
%   the mean and movmean function instead.
%--------------------------------------------------------------------------
%
...
%   <a href="matlab:help matlab.System/reset   ">reset</a>    - Reset the states of running mean
%
%   Mean properties:
%
