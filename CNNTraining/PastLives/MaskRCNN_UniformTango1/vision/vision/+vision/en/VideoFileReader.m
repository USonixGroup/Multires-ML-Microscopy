...
%
%   -----------------------------------------------------------------------
%   vision.VideoFileReader will be removed in a future release. Please use
%   VideoReader instead.
%   -----------------------------------------------------------------------
%
...
%   <a href="matlab:help matlab.System/reset   ">reset</a>    - Reset to the beginning of the video file
%   isDone   - Returns true if object has reached end-of-file
%   <a href="matlab:help matlab.System/info   ">info</a>     - Returns information about the specified video file
%
...
%
%   See also VideoReader, vision.VideoFileWriter, vision.VideoPlayer, implay
...
%   Copyright 2004-2022 The MathWorks, Inc.
    ...
    methods
        ...
        function out=canOutputAudio(~) %#ok<STOUT>
        end

        function out=canOutputVideo(~) %#ok<STOUT>
        end

        function out=getOutputStreams(~) %#ok<STOUT>
        end
        ...
        function out=setFileInfoProps(~) %#ok<STOUT>
        end

        function out=shouldOutputAudio(~) %#ok<STOUT>
        end
