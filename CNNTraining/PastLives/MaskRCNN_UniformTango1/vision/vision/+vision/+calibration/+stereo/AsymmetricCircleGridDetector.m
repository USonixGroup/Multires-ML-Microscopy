...
% AsymmetricCircleGridDetector Interface for asymmetric circle grid detection for stereo camera calibration.
%   
%   AsymmetricCircleGridDetector specifies the interface for an asymmetric
%   circle grid detector to be used for stereo camera calibration in the Stereo
%   Camera Calibrator App and from the command line.
%
