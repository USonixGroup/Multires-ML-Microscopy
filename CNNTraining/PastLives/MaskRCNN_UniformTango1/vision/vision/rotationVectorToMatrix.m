...
%
%--------------------------------------------------------------------------
% rotationVectorToMatrix is not recommended. Use rotvec2mat3d instead.
%--------------------------------------------------------------------------
%
% rotationMatrix = rotationVectorToMatrix(rotationVector) reconstructs a
% 3-D rotationMatrix from a rotationVector (axis-angle representation) using
...
%
% See also rotmat2vec3d, cameraParameters, estrelpose, estworldpose,
%          estimateExtrinsics.
