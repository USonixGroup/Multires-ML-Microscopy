...
#$ -wd /home/zcemydo/Scratch/NewTrain2
...
cp ~/Scratch/NewTrain2/Train8CatDWT.m $TMPDIR
cp ~/Scratch/NewTrain2/MATReaderDWT.m $TMPDIR
...
tar zcvf $HOME/Scratch/NewTrain2/DWT8C_${JOB_ID}.tgz $TMPDIR
