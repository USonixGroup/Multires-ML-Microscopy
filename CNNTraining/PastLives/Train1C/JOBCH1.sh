...
#$ -wd /home/zcemydo/Scratch/Train1C
...
cp ~/Scratch/Train1C/train1cmyriad.m $TMPDIR
cp ~/Scratch/Train1C/MATReader1C.m $TMPDIR
cp -r ~/Scratch/Train1C/src $TMPDIR
...
#run matlab script(s)
matlab -nosplash -nodesktop -nodisplay < train1cmyriad.m


# tar up all contents of $TMPDIR back into your space
tar zcvf $HOME/Scratch/Train1C/files_from_job_${JOB_ID}.tgz $TMPDIR
